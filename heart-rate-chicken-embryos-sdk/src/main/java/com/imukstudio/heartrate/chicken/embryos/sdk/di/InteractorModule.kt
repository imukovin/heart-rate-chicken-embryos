...
import com.imukstudio.heartrate.chicken.embryos.sdk.interactor.impl.JournalInteractorImpl
...
internal val interactorModule = DI.Module(name = "interactor") {
    ...
    bindProvider<JournalInteractor> { JournalInteractorImpl(instance()) }
}